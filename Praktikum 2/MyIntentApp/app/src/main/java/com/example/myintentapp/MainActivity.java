    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Maghviraturreimadhiney");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NPM, 1917051021);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Maghviraturreimadhiney");
                mPerson.setAge(20);
                mPerson.setEmail("maghviraturreimadhiney.102119@students.unila.ac.id");
                mPerson.setCity("Metro");
